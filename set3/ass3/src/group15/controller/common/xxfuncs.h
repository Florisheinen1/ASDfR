...
/* XXDelay is model specific and therefore implemented in LoopController.cpp */
/* XXInitialValue is model specific and therefore implemented in LoopController.cpp */
...
/* XXStopSimulation is implemented in LoopController.cpp */
