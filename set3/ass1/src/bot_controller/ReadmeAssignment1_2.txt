...
2. paste the packages bot_controller and relbot simulator along with packages of section 1.
...
2. launch the manual setpoint controller : ros2 run bot_controller sequence_controller
...
5. launch the image sequence controller: ros2 run bot_controller imgsqcontrol
